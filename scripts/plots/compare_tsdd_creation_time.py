    ...
    if err_file:
        with open(err_file, "r") as f:
            ...
            for problem, reason in errors.items():
                ...
                elif reason == "timeout" or "alloc" in reason:
                    timeouts += 1
                    times[problem_name] = DEFAULT_TIMEOUT
                else:
    ...
    for base_dir in paths:
        for root, _, files in os.walk(base_dir):
            for file in files:
                ...
                times[problem_name] = (
                    data["T-SDD"][CURRENT_TOTAL_TIME_KEY] + tlemmas_times[problem_name]
                )
                assert tlemmas_times[problem_name] != 0
                assert times[problem_name] > data["T-SDD"][CURRENT_TOTAL_TIME_KEY]
...
def compute_sizes(phi_path: str, base_path: str) -> tuple:
    ...
    tbdd = TheorySDD(phi, folder_name=base_path)
...
def create_cactus_plot(
    ...
    # title = f"T-SDD creation with different lemmas: {x1_label} vs {x2_label}"
    # if x3_data is not None:
    #     title += f" vs {x3_label}"
    #     if x4_data is not None:
    #         title += f" vs {x4_label}"
...
if __name__ == "__main__":
    ...
    #     "data/results/tsdd_seq/tsdd_sequential/errors.json",
    #     [
    #         "data/results/tsdd_seq/tsdd_sequential/data/serialized_tdds/ldd_randgen/data",  # noqa
    #         "data/results/tsdd_seq/tsdd_sequential/data/serialized_tdds/randgen/data",  # noqa
    #     ],
    ...
    #     "data/results/tsdd_par/tsdd_parallel/errors.json",
    #     [
    #         "data/results/tsdd_par/tsdd_parallel/data/serialized_tdds/ldd_randgen/data",  # noqa
    #         "data/results/tsdd_par/tsdd_parallel/data/serialized_tdds/randgen/data",  # noqa
    #     ],
    ...
    #     out_path="tsdd_creation_only_all.pdf",
    # )
    ...
    create_scatter_plot(
        ...
        y_label="T-red SDD",
        out_path="phi_nodes_vs_tsdd_nodes.pdf",
        log_scale=True,
        upperbound=10**5 * 2,
        alpha=0.4,
    )
